...
- Choose the smallest tool that answers the question: use read for bounded file ranges, grep for text, glob for exact paths, find_files for fuzzy paths, structural_search for code shapes, and lsp for symbols.
